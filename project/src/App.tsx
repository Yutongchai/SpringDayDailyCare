            ...
            <div className="space-y-6 animate-fade-in-left">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="text-center p-6 bg-purple-50 rounded-2xl">
                  ...
                  <div className="text-sm text-gray-600">Natural Materials</div>
                </div>
                <div className="text-center p-6 bg-purple-50 rounded-2xl">
                  <div className="text-3xl font-bold text-purple-600 mb-2">
                    2023
      ...
      <section id="why-us" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {(translations[lang].faq.items as any[]).map(
              (item: any, idx: number) => (
                <div
                  key={idx}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t("social.desc")}</p>
          </div>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  {item.id === "xhs" && (
                    <span className="text-white font-bold text-lg">小红书</span>
                  )}
                  {item.id === "shopee" && (
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-semibold">Spring Day Daily Care</span>
              </div>
              <p className="text-purple-200 text-sm leading-relaxed">
                Premium daily care essentials crafted with love and care for you
                and your loved ones.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-purple-200 text-sm">
                {translations[lang].products.items.map((it: any) => (
